...
const guardarContacto= () => { 
  ...
  // esta funcion guarda un contacto en la API
      ...
      <div className="col-md-6 bg-light p-4 rounded shadow">
        ...
        <form className="row g-3 "
          ...
          <div className="col-12">
            ...
            <input type="text" className="form-control text-lowercase" name="phone" id="inputAddress"
              placeholder="Ex: 621 12 34 56"
              value={form.phone}
              onChange={cambiosTexto}  />
          </div>
          ...
          <div className="col-12">
            ...
            <input type="text" className="form-control" name="address" id="inputAddress"
              placeholder="Nombre de la Calle, numero , ciudad, CP..." 
              value={form.address}
              onChange={cambiosTexto} />
          </div>
